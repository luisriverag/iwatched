...
class RatingImporter extends Importer implements ImporterInterface
{
    ...
    public function index(): ImporterInterface
    {
        ...
        DB::raw(DB::statement('UPDATE "titles" SET weight = TRUNC(ROUND(((ratings.num_votes*ratings.average_rating + (25000*7))/( ratings.num_votes+25000))::numeric, 8)*100000000) FROM "ratings" WHERE "titles"."tconst" = "ratings"."tconst"'));
